...
//
//            let randomValue: CGFloat = (255.0 * 3.0)
//            let first = CGFloat(pixelData[i])
//            let second = CGFloat(pixelData[i+1])
//            let third = CGFloat(pixelData[i+2])
//            let val = (first + second + third) / randomValue
//
//            result.append(val)
//        }
//
